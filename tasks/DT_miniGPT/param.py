...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--experiment_id', type=str, required=False)
        ...
        self.parser.add_argument('--cuda', type=int, choices=range(4),required=False)
        self.parser.add_argument('--reward_strategy', type=int, choices=range(1,8), required=False)
        ...
        self.parser.add_argument('--epochs', type=int, required=False)
        ...
        self.parser.add_argument('--mode', type=str, choices=['train', 'val', 'debug'], required=False)
        self.parser.add_argument('--fusion_type', type=str, choices=['bert', 'simple', 'lstm'], required=False)
        self.parser.add_argument('--target_rtg', type=float, required=False)
